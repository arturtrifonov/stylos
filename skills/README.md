...
| --- | ---: | --- | --- |
| `stylos-naming-cleanup` | 0.13 | Renames directly; reports the resulting state | [src/naming-cleanup/SKILL.md](src/naming-cleanup/SKILL.md) |
